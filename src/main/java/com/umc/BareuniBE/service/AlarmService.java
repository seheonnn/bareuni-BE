...
import com.umc.BareuniBE.repository.AlarmRepository;
import com.umc.BareuniBE.repository.CommunityRepository;
import com.umc.BareuniBE.repository.EmitterRepository;
...
import static com.umc.BareuniBE.global.BaseResponseStatus.COMMUNITY_EMPTY_ID;
...
public class AlarmService {
    ...
    public void createAlarm(AlarmType alarmType, Timestamp createdAt, String content, Long communityIdx, Long userIdx) throws BaseException {
        ...
        Alarm newAlarm = Alarm.builder()
                ...
                .url(String.valueOf(communityIdx))
                .build();
